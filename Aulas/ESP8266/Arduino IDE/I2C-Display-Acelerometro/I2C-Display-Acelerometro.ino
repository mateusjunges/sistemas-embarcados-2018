...
void setup() {
  ...
  Wire.beginTransmission(ENDERECO_MPU); //inicia a trasmissao em  0x68
  Wire.write(0x6B); //tenta escrever em 0x6b. Se conseguir enviar, significa que o MCU tá no ar
...
float lePosicao() {
  ...
  Wire.requestFrom(ENDERECO_MPU, 14, 1); //endereço, tamanho e manter ligado, sem fechar a transimssao
